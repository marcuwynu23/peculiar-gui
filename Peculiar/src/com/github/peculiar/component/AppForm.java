...
public class AppForm extends com.github.peculiar.component.Form {
    public AppForm() {
        super();
        super.setLocationRelativeTo(null);
    }
    public AppForm(com.github.peculiar.component.Label peculiarLabel) {
        setFormPane(peculiarLabel);
        super.setLocationRelativeTo(null);

    }
    public AppForm(com.github.peculiar.component.Panel peculiarPanel) {
